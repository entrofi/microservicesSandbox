...
DROP TABLE IF EXISTS  KBMS_CITY;
CREATE TABLE KBMS_CITY
(
  ID           NUMBER(19)                       NOT NULL,
  CREATE_DATE  TIMESTAMP(6),
  IP_ADDRESS   VARCHAR2(255 CHAR),
...
DROP TABLE IF EXISTS  KBMS_CITY_AIRPORTS;
CREATE TABLE KBMS_CITY_AIRPORTS
(
  KBMS_CITY_ID  NUMBER(19)                         NOT NULL,
  AIRPORTS_ID   NUMBER(19)                         NOT NULL
);
DROP TABLE IF EXISTS  KBMS_CITY_AIRPORTS_AUD;
CREATE TABLE KBMS_CITY_AIRPORTS_AUD
(
  REV        NUMBER(10)                         NOT NULL,
  KBMS_CITY_ID  NUMBER(19)                         NOT NULL,
  AIRPORTS_ID   NUMBER(19)                         NOT NULL,
...
DROP TABLE IF EXISTS  KBMS_CITY_AUD;
CREATE TABLE KBMS_CITY_AUD
(
  ID       NUMBER(19)                           NOT NULL,
  REV      NUMBER(10)                           NOT NULL,
  REVTYPE  NUMBER(3),
...
DROP TABLE IF EXISTS  KBMS_STATE;
CREATE TABLE KBMS_STATE
(
  ID           NUMBER(19)                       NOT NULL,
  CREATE_DATE  TIMESTAMP(6),
  IP_ADDRESS   VARCHAR2(255 CHAR),
...
DROP TABLE IF EXISTS  KBMS_STATE_AUD;
CREATE TABLE KBMS_STATE_AUD
(
  ID       NUMBER(19)                           NOT NULL,
  REV      NUMBER(10)                           NOT NULL,
  REVTYPE  NUMBER(3),
...
CREATE UNIQUE INDEX UK_2HRG9VJPONHY2XJHU2YGNX6O7 ON KBMS_CITY_AIRPORTS
(AIRPORTS_ID);
...
CREATE UNIQUE INDEX UK_L68H4CN2WMECV13ST7031179Q ON KBMS_CITY
(CODE);
...
CREATE UNIQUE INDEX UK_SDN1IR60ILOQN5H0FPCD1JNTK ON KBMS_STATE
(NAME);
...
ALTER TABLE KBMS_CITY ADD
PRIMARY KEY (ID) ;
ALTER TABLE KBMS_CITY ADD CONSTRAINT UK_L68H4CN2WMECV13ST7031179Q
UNIQUE (CODE);

ALTER TABLE KBMS_CITY_AIRPORTS ADD
PRIMARY KEY
  (KBMS_CITY_ID, AIRPORTS_ID);
ALTER TABLE KBMS_CITY_AIRPORTS ADD CONSTRAINT UK_2HRG9VJPONHY2XJHU2YGNX6O7
UNIQUE (AIRPORTS_ID)
;

ALTER TABLE KBMS_CITY_AIRPORTS_AUD ADD
PRIMARY KEY
  (REV, KBMS_CITY_ID, AIRPORTS_ID);

ALTER TABLE KBMS_CITY_AUD ADD
PRIMARY KEY
  (ID, REV);
...
ALTER TABLE KBMS_STATE ADD
PRIMARY KEY (ID) ;
ALTER TABLE KBMS_COUNTRY ADD CONSTRAINT UK_SDN1IR60ILOQN5H0FPCD1JNTK
UNIQUE (NAME);

ALTER TABLE KBMS_STATE_AUD ADD
PRIMARY KEY
  (ID, REV);
...
REFERENCES KBMS_STATE (ID);
ALTER TABLE KBMS_CITY ADD CONSTRAINT FK_INVL2VPPPWURLX93NLCR6SI4P
FOREIGN KEY (COUNTRY_ID)
REFERENCES KBMS_COUNTRY (ID);
...
ALTER TABLE KBMS_CITY_AIRPORTS ADD CONSTRAINT FK_DGXWN5MQVH0S09RDSDC2UB0EH
FOREIGN KEY (KBMS_CITY_ID)
REFERENCES KBMS_CITY (ID);
...
ALTER TABLE KBMS_STATE ADD
CONSTRAINT FK_87OW3MH1M6O8GGWS9VCTBP3K1
FOREIGN KEY (COUNTRY_ID)
REFERENCES KBMS_COUNTRY (ID);

ALTER TABLE KBMS_STATE_AUD ADD
CONSTRAINT FK_B0ILSL2IPN3HTPRR9KK3FOT0P
FOREIGN KEY (REV)
REFERENCES REVINFO (REV);
